...
class CouponResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CouponResponseObjectResource
        //val modelInstance = CouponResponseObjectResource()
