...
class PostCatalogCategoryUpdateJobResponseDataTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PostCatalogCategoryUpdateJobResponseData
        //val modelInstance = PostCatalogCategoryUpdateJobResponseData()
