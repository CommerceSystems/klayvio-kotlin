...
class CampaignResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CampaignResponseObjectResource
        //val modelInstance = CampaignResponseObjectResource()
