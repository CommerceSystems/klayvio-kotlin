...
class MetricAggregateQueryResourceObjectTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of MetricAggregateQueryResourceObject
        //val modelInstance = MetricAggregateQueryResourceObject()
