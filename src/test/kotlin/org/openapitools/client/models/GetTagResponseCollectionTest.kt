...
class GetTagResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetTagResponseCollection
        //val modelInstance = GetTagResponseCollection()
