...
class GetListMemberResponseCollectionDataInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetListMemberResponseCollectionDataInner
        //val modelInstance = GetListMemberResponseCollectionDataInner()
