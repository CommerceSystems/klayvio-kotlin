...
class GetFormResponseCompoundDocumentDataTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetFormResponseCompoundDocumentData
        //val modelInstance = GetFormResponseCompoundDocumentData()
        ...
        // to test the property `id` - ID of the form. Generated by Klaviyo.
        should("test id") {
            // uncomment below to test the property
