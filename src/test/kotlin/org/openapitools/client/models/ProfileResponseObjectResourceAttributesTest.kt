...
class ProfileResponseObjectResourceAttributesTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ProfileResponseObjectResourceAttributes
        //val modelInstance = ProfileResponseObjectResourceAttributes()
