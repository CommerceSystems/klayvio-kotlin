...
class GetCatalogVariantResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetCatalogVariantResponse
        //val modelInstance = GetCatalogVariantResponse()
