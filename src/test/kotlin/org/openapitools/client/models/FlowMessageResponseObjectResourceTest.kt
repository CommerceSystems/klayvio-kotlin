...
class FlowMessageResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of FlowMessageResponseObjectResource
        //val modelInstance = FlowMessageResponseObjectResource()
