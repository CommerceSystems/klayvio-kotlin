...
import org.openapitools.client.models.SegmentMemberResponseObjectResourceAttributes
import org.openapitools.client.models.ProfileLocation

class SegmentMemberResponseObjectResourceAttributesTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SegmentMemberResponseObjectResourceAttributes
        //val modelInstance = SegmentMemberResponseObjectResourceAttributes()

        // to test the property `joinedGroupAt` - The datetime when this profile most recently joined the segment.
