...
class GetProfileResponseCollectionDataInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetProfileResponseCollectionDataInner
        //val modelInstance = GetProfileResponseCollectionDataInner()
