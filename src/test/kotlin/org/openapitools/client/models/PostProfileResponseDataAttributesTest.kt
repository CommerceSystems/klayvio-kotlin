...
class PostProfileResponseDataAttributesTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PostProfileResponseDataAttributes
        //val modelInstance = PostProfileResponseDataAttributes()
