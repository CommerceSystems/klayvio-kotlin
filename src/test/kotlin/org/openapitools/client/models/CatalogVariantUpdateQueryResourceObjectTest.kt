...
class CatalogVariantUpdateQueryResourceObjectTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CatalogVariantUpdateQueryResourceObject
        //val modelInstance = CatalogVariantUpdateQueryResourceObject()
