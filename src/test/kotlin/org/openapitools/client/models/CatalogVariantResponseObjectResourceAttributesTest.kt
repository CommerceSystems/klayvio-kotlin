...
class CatalogVariantResponseObjectResourceAttributesTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CatalogVariantResponseObjectResourceAttributes
        //val modelInstance = CatalogVariantResponseObjectResourceAttributes()
        ...
        // to test the property `created` - Date and time when the catalog item  variant was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
        should("test created") {
            // uncomment below to test the property
            //modelInstance.created shouldBe ("TODO")
        }

        // to test the property `updated` - Date and time when the catalog item variant was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
        should("test updated") {
            // uncomment below to test the property
