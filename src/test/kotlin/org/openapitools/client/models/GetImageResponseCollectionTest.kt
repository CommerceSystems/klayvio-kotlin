...
class GetImageResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetImageResponseCollection
        //val modelInstance = GetImageResponseCollection()
