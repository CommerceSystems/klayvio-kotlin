...
class GetAccountResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetAccountResponseCollection
        //val modelInstance = GetAccountResponseCollection()
