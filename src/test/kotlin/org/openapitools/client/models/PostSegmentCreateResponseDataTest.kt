...
class PostSegmentCreateResponseDataTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PostSegmentCreateResponseData
        //val modelInstance = PostSegmentCreateResponseData()
