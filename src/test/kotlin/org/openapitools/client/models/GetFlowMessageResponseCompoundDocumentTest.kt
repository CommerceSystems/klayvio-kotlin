...
class GetFlowMessageResponseCompoundDocumentTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetFlowMessageResponseCompoundDocument
        //val modelInstance = GetFlowMessageResponseCompoundDocument()
