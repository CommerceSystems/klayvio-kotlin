...
class ListResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ListResponseObjectResource
        //val modelInstance = ListResponseObjectResource()
