...
class SegmentResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SegmentResponseObjectResource
        //val modelInstance = SegmentResponseObjectResource()
