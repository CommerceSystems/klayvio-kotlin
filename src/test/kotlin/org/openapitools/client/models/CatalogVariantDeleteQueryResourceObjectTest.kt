...
class CatalogVariantDeleteQueryResourceObjectTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CatalogVariantDeleteQueryResourceObject
        //val modelInstance = CatalogVariantDeleteQueryResourceObject()
