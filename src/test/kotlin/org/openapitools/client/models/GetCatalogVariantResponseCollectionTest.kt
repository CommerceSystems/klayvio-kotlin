...
class GetCatalogVariantResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetCatalogVariantResponseCollection
        //val modelInstance = GetCatalogVariantResponseCollection()
