...
class ProfileResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ProfileResponseObjectResource
        //val modelInstance = ProfileResponseObjectResource()
