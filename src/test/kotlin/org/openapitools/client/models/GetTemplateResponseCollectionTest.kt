...
class GetTemplateResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetTemplateResponseCollection
        //val modelInstance = GetTemplateResponseCollection()
