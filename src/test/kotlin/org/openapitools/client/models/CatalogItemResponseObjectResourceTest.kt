...
class CatalogItemResponseObjectResourceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CatalogItemResponseObjectResource
        //val modelInstance = CatalogItemResponseObjectResource()
