...
class GetListResponseCollectionDataInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetListResponseCollectionDataInner
        //val modelInstance = GetListResponseCollectionDataInner()
