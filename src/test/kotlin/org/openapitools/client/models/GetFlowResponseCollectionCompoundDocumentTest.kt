...
class GetFlowResponseCollectionCompoundDocumentTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetFlowResponseCollectionCompoundDocument
        //val modelInstance = GetFlowResponseCollectionCompoundDocument()
