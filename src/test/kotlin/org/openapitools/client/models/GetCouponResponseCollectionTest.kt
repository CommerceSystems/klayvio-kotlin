...
class GetCouponResponseCollectionTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetCouponResponseCollection
        //val modelInstance = GetCouponResponseCollection()
