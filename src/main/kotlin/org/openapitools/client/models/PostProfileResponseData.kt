...
data class PostProfileResponseData (

    @Json(name = "type")
    val type: ProfileEnum,

    @Json(name = "attributes")
    val attributes: PostProfileResponseDataAttributes,
    ...
    val relationships: GetProfileResponseCompoundDocumentDataAllOfRelationships? = null
