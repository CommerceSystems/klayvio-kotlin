 ...
 * @param created Date and time when the catalog item  variant was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
 * @param updated Date and time when the catalog item variant was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
 */


data class CatalogVariantResponseObjectResourceAttributes (
    ...
    val inventoryPolicy: CatalogVariantResponseObjectResourceAttributes.InventoryPolicy? = null,
