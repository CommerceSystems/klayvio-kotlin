 ...
 * @param startedAt Date and time the job started processing in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
 */


data class ProfileImportJobResponseObjectResourceAttributes (

    /* Status of the asynchronous job. */
    @Json(name = "status")
    val status: ProfileImportJobResponseObjectResourceAttributes.Status,
