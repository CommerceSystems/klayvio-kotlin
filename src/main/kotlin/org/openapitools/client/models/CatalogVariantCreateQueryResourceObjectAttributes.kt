 ...
 * 
 *
 * @param externalId The ID of the catalog item variant in an external system.
...
data class CatalogVariantCreateQueryResourceObjectAttributes (
    ...
    val integrationType: CatalogVariantCreateQueryResourceObjectAttributes.IntegrationType? = IntegrationType.DollarCustom,
    ...
    val inventoryPolicy: CatalogVariantCreateQueryResourceObjectAttributes.InventoryPolicy? = InventoryPolicy._0,
