...
data class ProfileMetricConditionTimeframeFilter (
    ...
    @Json(name = "operator")
    val `operator`: ProfileMetricConditionTimeframeFilter.`Operator`,
    ...
    @Json(name = "unit")
    val unit: ProfileMetricConditionTimeframeFilter.Unit,
