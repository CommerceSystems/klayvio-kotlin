...
data class GetCatalogVariantDeleteJobResponseCollectionDataInner (

    @Json(name = "type")
    val type: CatalogVariantBulkDeleteJobEnum,
    ...
    val relationships: GetCatalogVariantDeleteJobResponseCollectionDataInnerAllOfRelationships? = null
